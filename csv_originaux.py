...
def traiter_fichier(chemin_fichier, date, parquets, bague):
    ...
    if chemin_fichier not in existing_file_name:
        ...
        enregistrer_resultats(result_df, 'results_originaux.db')
...
def traiter_tous_les_fichiers(chemin_dossier, date, parquets, bague):
    """
    ...
    for fichier in os.listdir(chemin_dossier):
        if fichier.endswith('.csv'):
            ...
            df = traiter_fichier(chemin_fichier, date, parquets, bague)  
...
def main():
    ...
    df_final = traiter_tous_les_fichiers(chemin_dossier, date, parquet, bague)  # Traiter tous les fichiers CSV
